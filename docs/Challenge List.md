...
> Nguồn: `GET /api/challenges` | Tổng: **112 challenges** | Sắp xếp: độ khó tăng dần

---

## STT | Tên Challenge | Danh mục | Độ khó | Mục tham chiếu WSTG | Nhận xét
---|---|---|---|---|---
...
| Danh mục | Số lượng | % |
|---|---|---|
| Injection (SQLi, NoSQL, XXE, SSTi) | 14 | 12.5% |
| Broken Access Control | 13 | 11.6% |
| Sensitive Data Exposure | 11 | 9.8% |
| XSS | 9 | 8.0% |
| Improper Input Validation | 9 | 8.0% |
| Broken Authentication | 8 | 7.1% |
| Vulnerable Components | 7 | 6.3% |
| Miscellaneous | 7 | 6.3% |
| Cryptographic Issues | 5 | 4.5% |
| Observability Failures | 4 | 3.6% |
| Security Misconfiguration | 4 | 3.6% |
| Broken Anti Automation | 4 | 3.6% |
| Insecure Deserialization | 3 | 2.7% |
| Security through Obscurity | 3 | 2.7% |
| AI/LLM | 3 | 2.7% |
| Web3 | 4 | 3.6% |
| Unvalidated Redirects | 2 | 1.8% |
| XXE | 2 | 1.8% |
| **TỔNG** | **112** | **100%** |

---

## Challenges đã làm (theo báo cáo)

| STT | Tên | Mã WSTG |
|---|---|---|
| 1 | Score Board | INFO-01 |
| 5 | Error Handling | ERRH-01 |
| 7 | Repetitive Registration | IDNT-02 |
| 14 | Admin Section | AUTHZ-01 |
| 16 | View Basket | AUTHZ-04 |
| 17 | Login Admin | AUTH-04 |
| 23 | Security Policy | INFO-01 |
| 32 | Admin Registration | IDNT-01 |
| 41 | Login Jim | AUTH-04 |
| 52 | Reset Jim's Password | IDNT-04 |

---

## Liên kết với WSTG

| WSTG Category | Challenges tương ứng |
|---|---|
| WSTG-INFO | 3, 19, 23, 35, 36, 42, 53, 72, 75, 97 |
| WSTG-CONF | 6, 13, 22, 27, 37, 44, 88, 89, 96, 107 |
| WSTG-IDNT | 4, 7, 15, 25, 38, 45-51, 68-71, 101-103 |
| WSTG-AUTH | 7, 15, 38, 45-51, 60, 68-71, 81 |
| WSTG-AUTHZ | 5, 23, 30, 32, 33, 39, 52, 65, 73, 87, 99, 112 |
| WSTG-SESS | 34, 82 |
| WSTG-INPVAL | 4, 16, 17, 18, 21, 26, 28, 40, 56-58, 61, 66, 77, 83, 84, 85, 91, 92, 93, 94, 95, 104, 105, 110, 111 |
| WSTG-ERRH | 3, 27 |
| WSTG-CRYP | 31, 41, 55, 62, 89 |
| WSTG-BUSLOGIC | 14, 28, 30, 54, 61, 98 |
| WSTG-CLIENT | 2, 17, 18, 20, 40, 66, 77, 86, 96, 100 |
